 ...
 */
public class MainTwilker extends Activity implements View.OnClickListener {
    ...
    private void loginToTwitter() {
        ...
        if (!isLoggedIn) {
            ...
            try {
                ...
                intent.putExtra(activity_webview.EXTRA_URL, requestToken.getAuthenticationURL());
    ...
    class updateTwitterStatus extends AsyncTask<String, String, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(MainTwilker.this);
        ...
        protected void onPostExecute(Void result) {
            ...
            Toast.makeText(MainTwilker.this, "Posted to Twitter!", Toast.LENGTH_SHORT).show();
